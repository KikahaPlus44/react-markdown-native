...
export default {
  ...
  Hardbreak: () => <View />,
  Paragraph: props => <Text style={{ marginBottom: 26 }}>{props.children}</Text>,
  ...
  Heading: props => <Text style={{ fontSize: levelsFontSize[props.level], marginBottom: 10 }}>{props.children}</Text>,
